...
//!
//! Tests are ignored by default because they require `.npz` fixture files
//! generated by the Python reference implementation. To generate and run:
//!
//!   1. Generate fixtures: `python tests/generate_fixtures.py`
//!   2. Run ignored tests: `cargo test --features testing -- --include-ignored`
