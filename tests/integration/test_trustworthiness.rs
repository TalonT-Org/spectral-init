...
fn record_avx2_looped_correctness() {
    ...
    let record = format!(
        r#"{{"variant":"avx2_looped","rust_score":{rust_score:.15},"sklearn_score":{sklearn_score:.15},"delta":{delta:.2e},"passed":{passed}}}"#
    );
...
fn record_avx512_looped_correctness() {
    ...
    let record = format!(
        r#"{{"variant":"avx512_looped","rust_score":{rust_score:.15},"sklearn_score":{sklearn_score:.15},"delta":{delta:.2e},"passed":{passed}}}"#
    );
