...
use spectral_init::{ComputeMode, compute_degrees};
...
make_comp_a_python_compat_test!(
    comp_a_degrees_matches_python_blobs_connected_200,
    "blobs_connected_200",
    200
);
make_comp_a_python_compat_test!(
    comp_a_degrees_matches_python_blobs_connected_2000,
    "blobs_connected_2000",
    2000
);
make_comp_a_python_compat_test!(
    comp_a_degrees_matches_python_disconnected_200,
    "disconnected_200",
    200
);
make_comp_a_python_compat_test!(comp_a_degrees_matches_python_moons_200, "moons_200", 200);
make_comp_a_python_compat_test!(
    comp_a_degrees_matches_python_circles_300,
    "circles_300",
    300
);
make_comp_a_python_compat_test!(
    comp_a_degrees_matches_python_near_dupes_100,
    "near_dupes_100",
    100
);
...
make_comp_a_rust_native_test!(
    comp_a_degrees_rust_native_blobs_connected_200,
    "blobs_connected_200",
    200
);
make_comp_a_rust_native_test!(
    comp_a_degrees_rust_native_blobs_connected_2000,
    "blobs_connected_2000",
    2000
);
make_comp_a_rust_native_test!(
    comp_a_degrees_rust_native_disconnected_200,
    "disconnected_200",
    200
);
...
make_comp_a_rust_native_test!(
    comp_a_degrees_rust_native_near_dupes_100,
    "near_dupes_100",
    100
);
