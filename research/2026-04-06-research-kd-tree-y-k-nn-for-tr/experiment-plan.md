...
|---------|--------|------------|---------|
| uniform_n{1k,5k,10k,50k,75k,100k}_x.npy | Generated by gen_data.py | n×10, U(0,1) | Input X for uniform condition |
| uniform_n{1k,5k,10k,50k,75k,100k}_y.npy | Generated by gen_data.py | n×2, U(0,1) | Input Y for uniform condition |
| gauss_n{1k,5k,10k,50k,75k,100k}_x.npy | Generated by gen_data.py | n×10, U(0,1) | Input X for Gaussian condition |
| gauss_n{1k,5k,10k,50k,75k,100k}_y.npy | Generated by gen_data.py | n×2, 8-cluster Gaussian mixture | Input Y for Gaussian condition |

**Note:** n=75K was added during execution as a held-out crossover validation point
(RT8) and is included in all analyses. The original plan listed only {1K,5K,10K,50K,100K};
this manifest has been corrected to match the executed scope (24 total files).

**Data manifest source_type tags (W9):**
All 24 files: `source_type: generated` — produced by `scripts/gen_data.py` from
