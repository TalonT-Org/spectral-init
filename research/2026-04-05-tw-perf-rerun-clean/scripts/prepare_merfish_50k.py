"""Prepare MERFISH PCA-50 data at 50k scale for tw-perf-rerun-clean experiment.

Usage:
    python scripts/prepare_merfish_50k.py \
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prepare MERFISH PCA-50 data at 50k scale")
    ...
    parser.add_argument("--n", type=int, default=50000,
                        help="Number of cells to slice (default: 50000)")
